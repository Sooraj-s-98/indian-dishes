...
const DishDetails = () => {
  ...
  return (
    <div className="container mx-auto px-4">
      ...
      <p><strong>Preparation Time:</strong> {dish?.prep_time ? `${dish.prep_time} minutes` : 'N/A'}</p>
      <p><strong>Cooking Time:</strong> {dish?.cook_time ? `${dish.cook_time} minutes` : 'N/A'}</p>
      <p><strong>Flavor Profile:</strong> {dish?.flavor_profile}</p>
      <p><strong>Course:</strong> {dish?.course}</p>
      <p><strong>State of Origin:</strong> {dish?.state}</p>
